class HTChallenge:
    ...
    def launch(cls, chpp, team_ht_id, opponent_team_ht_id,
               match_type, match_place, arena_ht_id=0, match_period='week'):
        ...
        elif match_place not in ('home_away', 'neutral'):
            raise ValueError("match_type must be equal to 'home_away' or 'neutral'")
        ...
        cls._REQUEST_ARGS['action_type'] = 'challenge'
        ...
        cls._REQUEST_ARGS['matchPlace'] = {'home_away': '0', 'neural': '1'}[match_place]
