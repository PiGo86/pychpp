...
class HTYouthPlayer(HTCorePlayer):
    ...
    _ht_attributes = [("ht_id", ".//YouthPlayerID", ht_xml.HTXml.ht_int,),
                      ...
                      ("career_hattricks", ".//CareerHattricks",
                       ht_xml.HTXml.ht_int,),
                      ("league_goals", ".//LeagueGoals", ht_xml.HTXml.ht_int,),
                      ("friendly_goals", ".//FriendlyGoals",
                       ht_xml.HTXml.ht_int,),
                      ("team_id", ".//OwningYouthTeam/YouthTeamID",
                       ht_xml.HTXml.ht_int,),
                      ("team_name", ".//OwningYouthTeam/YouthTeamName",
                       ht_xml.HTXml.ht_str,),
                      ("team_league_id",
                       ".//OwningYouthTeam/YouthTeamLeagueID",
                       ht_xml.HTXml.ht_int,),
                      ("senior_team_id",
                       ".//OwningYouthTeam/SeniorTeam/SeniorTeamID",
                       ht_xml.HTXml.ht_int,),
                      ("senior_team_name",
                       ".//OwningYouthTeam/SeniorTeam/SeniorTeamName",
                       ht_xml.HTXml.ht_str,),
                      ("skills", ".//KeeperSkill/..",
