...
from pychpp.models.xml.match_details import RequestMatchDetails, Match, MatchHomeTeam, MatchAwayTeam
...
class HTMatch(BaseHTMatch, RequestMatchDetails, Match):
    ...
    home_team: 'HTMatchHomeTeam' = HTField('.', xml_prefix='HomeTeam/', suppl_attrs={'source_system': 'source_system'})
    away_team: 'HTMatchAwayTeam' = HTField('.', xml_prefix='AwayTeam/', suppl_attrs={'source_system': 'source_system'})
