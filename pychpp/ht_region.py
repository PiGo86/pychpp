class HTRegion:
    ...
    def __init__(self, chpp, ht_id=None):
        ...
        self.number_of_users = int(region_data.find('NumberOfUsers'))
        self.number_of_online = int(region_data.find('NumberOfOnline'))
        self.weather = int(region_data.find('WeatherID'))
        self.tomorrow_weather = int(region_data.find('TomorrowWeatherID'))
